...
namespace Nemro
{
    public partial class UserControl1 : UserControl
    {
        ...
        private void refreshType()
        {
            txtName.Items.Clear();
            Connection.conn.Open();
            SqlCommand cmd11 = Connection.conn.CreateCommand();
            cmd11.CommandType = CommandType.Text;
            cmd11.CommandText = "SELECT Type FROM Type";
            ...
            {
                comboBoxType.Items.Add(dr["Type"].ToString());
            }
            Connection.conn.Close();
        }
        ...
        private void fillcombo()
        {
            ...
            Connection.conn.Open();
            SqlCommand cmd4 = Connection.conn.CreateCommand();
            cmd4.CommandType = CommandType.Text;
            cmd4.CommandText = "SELECT Name FROM Item";
            ...
            txtItem.Items.AddRange(row.ToArray());

            //DisData.Columns.Add(combo);
            Connection.conn.Close();
        }
        ...
        public void search()
        {
            ...
            SqlCommand cmd = Connection.conn.CreateCommand();
            cmd.CommandType = CommandType.Text;
            cmd.CommandText = "SELECT * FROM Customer WHERE CusId= '" + txtId.Text + "' OR Name = '" + txtName.Text + "'";
            cmd.ExecuteNonQuery();
        ...
        //Calculate Total For Add to datagrid
        ...
        */
        ...
        public void Cash()
        {
            if (ckboxCus.Checked == true)
            {
                ...
                Connection.conn.Open();
                String query3 = "INSERT INTO Customer (Name,Address,Tp,Type,Balance,LastUpdate) VALUES ('" + txtName.Text + "','" + txtAddress.Text + "','" + txtTp.Text + "','" + comboBoxType.Text + "','" + balance + "','" + dtpicker.Text + "')";
                ...
                */
                ...
                for (int i = 0; i < DisData.Rows.Count - 1; i++)
                {
                    SqlCommand cmd2 = new SqlCommand("INSERT INTO Daily (Item,Reason,Quantity,Price,TotalPrice,Status,Id,Date) VALUES ('" + DisData.Rows[i].Cells[0].Value + "','" + DisData.Rows[i].Cells[1].Value + "','" + DisData.Rows[i].Cells[2].Value + "','" + DisData.Rows[i].Cells[3].Value + "','" + DisData.Rows[i].Cells[4].Value + "','"+ paid +"','"+ MyGlobal.datain + "', '" + dtpicker.Text + "')", Connection.conn);
            ...
            else
            {
                ...
                for (int i = 0; i < DisData.Rows.Count - 1; i++)
                {
                    SqlCommand cmd7 = new SqlCommand("INSERT INTO Daily (Item,Reason,Quantity,Price,TotalPrice,Status,Id,Date) VALUES ('" + DisData.Rows[i].Cells[0].Value + "','" + DisData.Rows[i].Cells[1].Value + "','" + DisData.Rows[i].Cells[2].Value + "','" + DisData.Rows[i].Cells[3].Value + "','" + DisData.Rows[i].Cells[4].Value + "','" + paid + "','" + MyGlobal.datain + "', '" + dtpicker.Text + "')", Connection.conn);
        ...
        public void Credit()
        {
            if (ckboxCus.Checked == true)
            {
                //Enter data to Customer Table 
                Connection.conn.Open();
                String query5 = "INSERT INTO Customer (Name,Address,Tp,Type,Balance,LastUpdate) VALUES ('" + txtName.Text + "','" + txtAddress.Text + "','" + txtTp.Text + "','" + comboBoxType.Text + "','" + MyGlobal.sumstr + "','" + dtpicker.Text + "')";
                ...
                for (int i = 0; i < DisData.Rows.Count - 1; i++)
                {
                    SqlCommand cmd3 = new SqlCommand("INSERT INTO Daily (Item,Reason,Quantity,Price,TotalPrice,Status,Id,Date) VALUES ('" + DisData.Rows[i].Cells[0].Value + "','" + DisData.Rows[i].Cells[1].Value + "','" + DisData.Rows[i].Cells[2].Value + "','" + DisData.Rows[i].Cells[3].Value + "','" + DisData.Rows[i].Cells[4].Value + "','" + unpaid + "','" + MyGlobal.datain + "','" + dtpicker.Text + "')", Connection.conn);
            ...
            else
            {
                ...
                for (int i = 0; i < DisData.Rows.Count - 1; i++)
                {
                    ...
                    SqlCommand cmd4 = new SqlCommand("INSERT INTO Daily (Item,Reason,Quantity,Price,TotalPrice,Status,Id,Date) VALUES ('" + DisData.Rows[i].Cells[0].Value + "','" + DisData.Rows[i].Cells[1].Value + "','" + DisData.Rows[i].Cells[2].Value + "','" + DisData.Rows[i].Cells[3].Value + "','" + DisData.Rows[i].Cells[4].Value + "','" + unpaid + "','" + MyGlobal.datain + "','" + dtpicker.Text + "')", Connection.conn);
